...
public class SobrepesoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoClassificacao.setText("Classificação: Sobrepeso");
        textoMensagem.setText(R.string.mensagem_sobrepeso);
        imagemCategoria.setImageResource(R.drawable.sobrepeso);
