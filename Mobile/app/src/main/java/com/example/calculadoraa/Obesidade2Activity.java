...
public class Obesidade2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoClassificacao.setText("Classificação: Obesidade Grau 2");
        textoMensagem.setText(R.string.mensagem_obesidade2);
        imagemCategoria.setImageResource(R.drawable.obesidade2);
