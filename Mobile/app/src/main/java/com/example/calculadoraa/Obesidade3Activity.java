...
public class Obesidade3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textoClassificacao.setText("Classificação: Obesidade Grau 3");
        textoMensagem.setText(R.string.mensagem_obesidade3);
        imagemCategoria.setImageResource(R.drawable.obesidade3);
